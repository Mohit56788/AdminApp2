package com.example.user.adminapp;
...
import com.example.user.adminapp.Menu_edit;
import com.example.user.adminapp.R_pay;
import com.example.user.adminapp.Sevent;
import com.example.user.adminapp.UoActivity;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
                                             ...
                                             public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                                                 switch (i) {
                                                     case 0:
                                                         ...
                                                         break;
                                                     case 1:
                                                         Intent intent1 = new Intent(MainActivity.this, Menu_edit.class);
    ...
    public boolean onNavigationItemSelected( MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.nav4:
                Intent intent2 = new Intent(MainActivity.this, Sevent.class);
                startActivity(intent2);

                break;

            case R.id.nav5:
                Intent intent3 = new Intent(MainActivity.this,R_pay.class);
